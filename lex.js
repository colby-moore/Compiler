...
function testCaseTwo() {
  ...
  document.getElementById("input").value += 'boolean b' + '\n'
  document.getElementById("input").value += 'b = true' + '\n'
  document.getElementById("input").value += 'string c' + '\n'
  document.getElementById("input").value += 'c = "alan"' + '\n'
  document.getElementById("input").value += 'print (a)' + '\n'
  document.getElementById("input").value += 'print (b)' + '\n'
  document.getElementById("input").value += 'print (c)' + '\n'
  document.getElementById("input").value += '{' + '\n'
  document.getElementById("input").value += 'int d' + '\n'
  document.getElementById("input").value += 'd = 6' + '\n'
  document.getElementById("input").value += 'string e' + '\n'
  document.getElementById("input").value += 'e = "cgen"' + '\n'
  document.getElementById("input").value += 'boolean f' + '\n'
  document.getElementById("input").value += 'f = false' + '\n'
  document.getElementById("input").value += 'print (d)' + '\n'
  document.getElementById("input").value += 'print (e)' + '\n'
  document.getElementById("input").value += 'print (f)' + '\n'
  document.getElementById("input").value += '}' + '\n'
  document.getElementById("input").value += '}$' + '\n'
